...
func setupCandidateImDB(t *testing.T) *gorm.DB {
	...
	imDB.Exec(`CREATE TABLE thread (id INTEGER PRIMARY KEY, short_id TEXT, name TEXT, group_no TEXT, status INTEGER DEFAULT 1)`)
...
func TestSearchChatCandidates_ThreadUsesGroupMember(t *testing.T) {
	...
	imDB.Exec(`INSERT INTO thread (id, short_id, name, group_no, status) VALUES (1, 'th001', 'Thread A', 'grp1', 1)`)
	imDB.Exec(`INSERT INTO thread (id, short_id, name, group_no, status) VALUES (2, 'th002', 'Thread B', 'grp1', 1)`)
