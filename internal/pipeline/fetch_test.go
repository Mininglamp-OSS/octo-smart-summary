...
func TestNormalizeDMChannelID(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "regression: WuKongIM min@max format from real report",
			channelID:   "9a45a51cd76c4e668e12cf10c2b797dd@1d60945f0d4e488fa8f237e270ad34af",
			selfUID:     "1d60945f0d4e488fa8f237e270ad34af",
			channelType: 1,
			want:        "1d60945f0d4e488fa8f237e270ad34af@9a45a51cd76c4e668e12cf10c2b797dd",
		},
		{
